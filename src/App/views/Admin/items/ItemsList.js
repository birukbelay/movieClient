...
import {selectItem} from "./store/item_actions";
...
const ItemsList=()=>{
  ...
  const currentPageItems = getSelectedFilterItems(state)
  ...
  const nodes = hasItems ? (
    ...
    return (
        <div>
          <DeleteItem setDisplay={SetDeleteDisplay} display={displayDelete} item={selectedItem}/>
          ...
          <div className="row">
            ...
            <div className="col-md-12">
              ...
              <div className="main-card mb-3 card">
                <div className={className}>
              {uploadStatus ===Status.ERROR && `There is some thing Wrong with ${query},  please try again!`}
              {uploadStatus===Status.SUCCESS && `${query} Success `}
...
function SingleItem({item = {}, SetDeleteDisplay, setItem}) {
